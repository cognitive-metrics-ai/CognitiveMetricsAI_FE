          ...
          <div class="flex items-center justify-center z-1">
            ...
            <div class="flex flex-col items-center max-w-xs">
              <router-link to="/" class="block mb-4">
                <img class="dark:hidden h-16 w-auto" src="/images/logo/logo_light.png" alt="Logo" />
                <img class="hidden dark:block h-16 w-auto" src="/images/logo/logo_dark.png" alt="Logo" />
              </router-link>
